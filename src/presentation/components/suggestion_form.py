...
def render_suggestion_form(suggestion_service):
    ...
    st.write("Help improve Berlin's charging infrastructure by suggesting "
             "new locations where charging stations are needed.")
    ...
    with st.form("suggestion_form"):
        ...
        reason = st.text_area(
            "Why is this location needed?",
            placeholder="Describe the need for charging stations here..."
        )
